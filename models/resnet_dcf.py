...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, num_bases, initializer, stride=1):
        super(BasicBlock, self).__init__()
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = CONV_DCF(planes, planes, kernel_size=3, stride=1, padding=1, bias=False,
                                num_bases=num_bases, initializer=initializer)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, num_bases, initializer ,stride=1):
        ...
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = CONV_DCF(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False,
                              num_bases=num_bases, initializer=initializer)
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channels, num_bases, initializer, num_classes=10):
